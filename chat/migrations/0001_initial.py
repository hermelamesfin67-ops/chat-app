# Generated by Django 6.0.8 on 2026-08-09 07:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('message_type', models.CharField(choices=[('text', 'Text'), ('image', 'Image'), ('video', 'Video'), ('audio', 'Audio'), ('sticker', 'Sticker'), ('file', 'File')], default='text', max_length=20)),
                ('media', models.FileField(blank=True, null=True, upload_to='message/')),
